/*
  ...
  Using touch sensor to generate random fortune.

  MR121
  LCD
  
  Code is refernced from Arduino Starter Kit example Project 11  - Crystal Ball  http://arduino.cc/starterKit
  and Bare Conductive Proximity LED Fader by Stefan Dzisiewski-Smith.
